...
export function VariablesModal({ isOpen, onClose }: VariablesModalProps) {
  ...
  const toggleVariableActive = useVariableStore(
    (state) => state.toggleVariableActive,
  );
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 ">
                <div className="flex gap-2 mb-4">
                  ...
                  <Button
                    variant="standard"
                    className="px-4 flex flex-row items-center text-[#C9FF3B] border border-[#C9FF3B] bg-[#C9FF3B]/10"
                  >
                ...
                <div className="space-y-6 max-h-[calc(100vh-280px)] overflow-y-auto relative border border-[#525252] bg-[#161618] rounded-[5px] px-0 py-0">
                        ...
                        <div className="flex flex-wrap gap-2 p-3 rounded-xl">
                          {category.variables.map((variable) => (
                            <Button
                              ...
                              variant="standard"
                              onMouseEnter={() =>
                                handleMouseEnter(variable.name)
                              }
                  ...
                  <AnimatePresence>
                    {showTooltip && (
                      ...
                      >
                        <h4 className="flex flex-row items-center text-white text-[18px] font-medium mb-2 -pl-4">
                          CO2 Distribution Details{" "}
                          <Info className="ml-2 h-4 w-4" />
                        </h4>
                        <p className="text-[15px] text-[#BBBBBB] max-w-xl text-left">
                          But what truly sets Switch apart is its versatility.
                          It can be used as a scooter, a bike, or even a
                          skateboard, making it suitable for people of all ages.
                          Whether you're a student, a professional, or a senior
                          citizen, Switch adapts to your needs and lifestyle.
                        </p>
                      </motion.div>
                    )}
                  </AnimatePresence>
              ...
              <div className="flex flex-row justify-between bg-[#222324] border border-[#525252] rounded-[4px] p-4 mx-4 mb-4 items-center">
                <h1 className="text-[20px] text-[#C8E972] font-normal">
                  Primary Variables
                </h1>
